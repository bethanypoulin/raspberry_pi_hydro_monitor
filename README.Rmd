...
Once set up with an mLabs account you will need to collect a few bit of informations, which mLab makes immediately available to you, to access your new database remotely.
You will need the following to connect with mLab using pymongo:  
    DATABASE NAME - you will choose this, this database will house the collection for your sensor & images 
    HOST - it will look something like `df39249mlab.com` with two numbers and five letters  
    PORT - this is the port your database is assigned to access via mLab  
    USERNAME - this user is defined by you within your database, you can have multiples with different   permission levels 
